...
type UploadButtonFileProps = {
  queue: File[];
  handleQueue: (
    queue: File[],
    queueTypeOrDirectory: QueueType | string
  ) => Promise<void>;
};
const UploadButtonFile = ({ queue, handleQueue }: UploadButtonFileProps) => {
...
export default memo(UploadButtonFile);
