...
export const ModeSelect = memo(({ rowNumber, currentMode, handleModeChange }: ModeSelectProps) => {
  return (
    <FormControl variant="standard" sx={{ m: 1, minWidth: 120 }}>
      <InputLabel sx={{ fontWeight: 'bold' }}>Mode</InputLabel>
      <Select
        value={currentMode}
        onChange={(event) => handleModeChange(rowNumber, event.target.value as 'calc' | 'detail')}
        label="mode"
      >
